...
export class GatekeeperHQClient {
	...
	public invitations: InvitationsService;
	...
	constructor(options: ClientOptions) {
		...
		this.permissions = new PermissionsService(this.axiosInstance);
		this.tenants = new TenantsService(this.axiosInstance);
		this.invitations = new InvitationsService(this.axiosInstance);
